...
______________________________________________________________________
______________________________________________________________________
Stack Navigator is like the chef managing the stack of plates (screens) in a restaurant.
useNavigation is like a waiter taking an order (user action) and communicating it to the chef (navigation system).