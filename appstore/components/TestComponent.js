...
import { StyleSheet, View, Text, Image, FlatList, ActivityIndicator, TextInput, TouchableOpacity, ScrollView, Platform } from 'react-native';
  ...
  <View>
    <View style={styles.transparent_svg}>
      <Svg height="100%" width="100%" viewBox="0 0 400 100" preserveAspectRatio='none'>
        <Path fill="white" d="M0 0 C50 0, 150 50, 200 50 S350 0, 400 10 L400 100 L0 100 Z" />
      </Svg>
    </View>
    <View style={styles.transparent_svg}>
      <Svg height="100%" width="100%" viewBox="0 0 400 100" preserveAspectRatio='none'>
        <Path fill="white" d="M0 100 Q200 -50, 400 100 Z" />
      </Svg>
    </View>
    <View style={styles.upper_svg}>
      <Svg height="100%" width="100%" viewBox="0 0 400 100" preserveAspectRatio='none'>
        <Path fill="white" d="M0 50 C50 110, 110 110, 200 50 S300 0, 400 90 L400 100 L0 100 Z" />
      </Svg>
    </View>
  </View>
));
